...
CKEDITOR.editorConfig = function( config )
{
  ...
  config.toolbar_Easy =
	...
	config.toolbar = 'mycongress';

	config.toolbar_mycongress =
	[
	    ['Bold', 'Italic', 'Underline','Strike','-','Subscript','Superscript', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink','-',]
	];
