class Vote < ActiveRecord::Base
  ...
  index [:voter_id, :voter_type]
  index [:voter_id, :voter_type, :vote]
  index [:voter_id, :voter_type, :vote, :voteable_id, :voteable_type]
  index [:voter_id, :voter_type, :voteable_id, :voteable_type]
